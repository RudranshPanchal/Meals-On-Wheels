					...
					<div class="row">
						...
						<div class="col-md-5 wow animated fadeInRight">
							<address class="contact-details">
								...
								<p style="color: beige"><i class="fa fa-pencil"></i>Meals-On-Wheels<span style="color: beige">50, Thiruvoodal Street,</span> <span style="color: beige">India.</span></p><br>
								<p style="color: beige"><i class="fa fa-phone"></i>+91 94884 87853</p>
								<p style="color: beige"><i class="fa fa-envelope"></i>mealsonwheels5@gmail.com</p>
							</address>
						</div>
...
</html><?php /**PATH C:\wamp64\www\mealsbootstrap\resources\views/contact.blade.php ENDPATH**/ ?>