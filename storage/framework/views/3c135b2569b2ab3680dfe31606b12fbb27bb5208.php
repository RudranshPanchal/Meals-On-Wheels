      ...
      <div class="col-12 col-md-10 d-none d-xl-block">
        ...
        <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
          ...
          <ul class="dropdown arrow-top">
            <li>  <a href="<?php echo e(route('partner#update')); ?>">Update </a></li>
            <li> <a href="<?php echo e(route('main')); ?>">
...
<footer id="footer">
  <div class="container">
    ...
    <!-- Single Page Nav -->
        <script src="<?php echo e(asset('js/jquery.singlePageNav.min.js')); ?>"></script>
  ...
  <?php /**PATH D:\module11\DEA\mealsbootstrap\mealsbootstrap\resources\views/Users/Volunteer/layouts/app.blade.php ENDPATH**/ ?>